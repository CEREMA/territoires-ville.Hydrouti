...
Begin VB.Form Frm_bv2 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frm_peu 
         ...
         End
         Begin VB.Label Lb_par_eu 
            Caption         =   "Intensité pluie de rinçage"
            Height          =   255
            Index           =   0
            Left            =   240
            TabIndex        =   34
   ...
   End
   Begin VB.Label Lb_debit1 
      Caption         =   "Débit de pluie de rinçage"
      Height          =   300
      Index           =   4
      Left            =   3840
      TabIndex        =   43
...
'                owner.fdessin.UC_graphiqueB.Visible = True
        ...
        If ret_bv Then
            ...
            End If
            ret_bv = False
            owner.affich_aide owner.fobjet.Name, "Dimensionnement d'un bassin de rétention"
        End If
    Else
        Unload Frm_desprint
